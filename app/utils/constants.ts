...
export const STARTER_TEMPLATES: Template[] = [
  {
    name: 'Formbird React Starter',
    label: 'Formbird React Starter',
    description: 'A starter template for building Formbird components with React',
    githubRepo: 'formbird/react-component-starter',
    tags: ['formbird', 'web', 'react', 'component', 'starter'],
    icon: 'i-bolt:react',
  },
  {
